...
function getDefaultParams(mf, range = [0, 1]) {
  ...
  switch (mf) {
    case "triangle":
      args = [
        parseFloat((0.1 * range).toFixed(4)),
        parseFloat((0.5 * range).toFixed(4)),
        parseFloat((0.9 * range).toFixed(4)),
      ];
      break;
    case "trapeze":
      args = [
        parseFloat((0.1 * range).toFixed(4)),
        parseFloat((0.4 * range).toFixed(4)),
        parseFloat((0.6 * range).toFixed(4)),
        parseFloat((0.9 * range).toFixed(4)),
      ];
      break;
    case "gauss":
      args = [
        parseFloat((0.17 * range).toFixed(4)),
        parseFloat((0.5 * range).toFixed(4)),
      ];
      break;
    case "sigma":
      args = [
        parseFloat((18 / range).toFixed(4)),
        parseFloat((0.5 * range).toFixed(4)),
      ];
      break;
    case "singleton":
